...
if ($loggedInUserID) {
    ...
    $query = "SELECT us.username, 
                     CONCAT(te.firstName, 
                            IFNULL(CONCAT(' ', te.middleName), ''), 
                            ' ', te.lastName) AS fullName, 
                     te.phoneNumber, 
                     te.emailAddress, 
                     te.dateOfBirth
              FROM user us JOIN tenant te ON us.tenant_ID = te.tenant_ID
...
<!-- Modal for TENANT account Details -->
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4 text-center">
                            <!-- Placeholder for tenant picture NOTE: currently directs to staff folder -->
