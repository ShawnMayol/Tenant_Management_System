...
<?php
    ...
    $billStmt->bind_param("i", $lease_ID);  // Use $lease_ID from lease table
    $billStmt->execute();
        ...
        <div class="col-md-4 mb-4">
            <a href="#" class="card-link">
                <div class="card bg-info-subtle hover-card shadow">
                    <div class="card-body">
                        <h5 class="card-title mb-3"><i class="bi bi-file-earmark-text h3" style="margin-right: 15px;"></i> Lease Agreement</h5>
                        <p class="card-text">Apartment Type: <strong><?php echo htmlspecialchars($apartmentType); ?></strong></p>
                        <p class="card-text">Start Date: <strong><?php echo date('F j, Y', strtotime($startDate)); ?></strong></p>
                        <p class="card-text">End Date: <strong><?php echo date('F j, Y', strtotime($endDate)); ?></strong></p>
        ...
        <div class="col-md-4 mb-4">
            <a href="#" class="card-link">
                <div class="card bg-success-subtle hover-card shadow">
                    <div class="card-body">
                        <h5 class="card-title mb-3"><i class="bi bi-credit-card h3" style="margin-right: 15px;"></i> Current Balance</h5>
                        <p class="card-text">Remaining Balance: <strong>₱<?php echo number_format($totalBalance, 2); ?></strong></p>
                        <p class="card-text">Overdue Balance: ₱<?php echo number_format($overdueBalance, 2); ?></p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md-4 mb-4">
            <a href="#" class="card-link">
                <div class="card bg-primary-subtle hover-card shadow">
                    <div class="card-body">
                        <h5 class="card-title mb-3"><i class="bi bi-cash-stack h3" style="margin-right: 15px;"></i> Payment History</h5>
                        <p class="card-text">Total Paid: <strong>₱<?php echo number_format($totalPaid, 2); ?></strong></p>
                        <p class="card-text">Last Payment: <?php echo htmlspecialchars($lastPaymentDate); ?></p>
                    </div>
                </div>
            </a>
        </div>
