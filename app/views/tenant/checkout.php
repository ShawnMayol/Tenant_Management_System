...
<div class="col-md-8">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="handlers/tenant/uploadProof.php" id="paymentForm" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="proofOfPayment" class="form-label">Proof of Payment</label>
                    <input type="file" class="form-control py-2" id="proofOfPayment" name="proofOfPayment"
