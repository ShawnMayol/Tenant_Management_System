        ...
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            ...
            <ul class="nav flex-column mb-auto">
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2 <?php echo $currentPage === 'admin.managers' ? 'selected' : 'highlight'; ?>" aria-current="page" href="index.php?page=admin.managers">
                  <svg class="bi" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                      <use xlink:href="<?php echo $currentPage === 'admin.managers' ? '#file-code-fill' : '#file-code'; ?>" />
                  </svg>
                  Managers
                </a>
              </li>
          ...
          <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item">
              <a id="logout-link" class="nav-link d-flex align-items-center gap-2 highlight" href="logout.php">
