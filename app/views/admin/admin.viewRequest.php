        ...
        <div class="container">
            <div class="row">
                <div class="col-auto ps-2 pe-3">
                    <a href="?page=admin.requests" class="icon-wrapper" style="text-decoration: none;">
    ...
    <div class="container mt-4 pt-2">
        <div class="row">
            ...
            <div class="col-lg-5 mb-4">
                <a href="?page=admin.viewApartment&apartment=<?php echo $apartment['apartmentNumber'];?>">
            ...
            <div class="col-lg-7 ps-4">
                ...
                <hr>
                <!-- Tenant details form -->
                <form action="?page=admin.leaseAgreement&request_id=<?php echo $requestID; ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
