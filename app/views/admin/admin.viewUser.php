        ...
        <div class="container">
            <div class="row">
                <div class="col-auto ps-2 pe-3">
                    <a href="?page=manager.tenants" class="icon-wrapper" style="text-decoration: none;">
                        ...
                        <tbody>
                            <?php if ($lease): ?>
                                <tr class="clickable-row"
                                    data-href="?page=manager.viewApartment&apartment=<?php echo htmlspecialchars($lease['apartmentNumber']); ?>">
                            ...
                            <tbody>
                                <?php if (!empty($occupants)): ?>
                                    <?php foreach ($occupants as $occupant): ?>
                                        <tr>
                                            <td class="py-3">
                                                <?= htmlspecialchars($occupant['firstName'] . ' ' . $occupant['middleName'] . ' ' . $occupant['lastName']) ?>
                                            </td>
