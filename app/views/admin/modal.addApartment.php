            ...
            <div class="modal-body">
                <form id="addApartmentForm" action="handlers/admin/addApartment.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control py-2" id="apartmentDimensions" name="apartmentDimensions" required>
                    </div>
                    <div class="mb-3">
                        <label for="apartmentAddress" class="form-label">Apartment Address*</label>
                        <input type="text" class="form-control py-2" id="apartmentAddress" name="apartmentAddress" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control py-2" id="apartmentImage" name="apartmentImage" accept="image/*" required>
                    </div>
                    <div class="mb-3">
                        <label for="apartmentDescription" class="form-label">Apartment Description*</label>
                        <textarea class="form-control py-2" id="apartmentDescription" name="apartmentDescription" rows="3"></textarea required>
                    </div>
