...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" data-theme="<?php echo $theme; ?>">
        ...
        <div class="container">
            <div class="row">
                <div class="col-auto ps-2 pe-3">
                    <a href="?page=manager.viewRequest&request_id=<?php echo $requestID ?>" class="icon-wrapper"
    ...
    <div class="container mt-4">
        <form id="leaseConfirmationForm" action="handlers/manager/leaseHandler.php" method="POST">
            ...
            <input type="hidden" name="apartmentNumber"
                value="<?php echo htmlspecialchars($apartment['apartmentNumber']); ?>">
            <input type="hidden" name="securityDeposit"
                value="<?php echo htmlspecialchars($apartment['rentPerMonth']); ?>">
                    ...
                    <div class="occupant mb-3">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" name="lesseeFirstName" id="firstName"
                                    value="<?php echo $tenantDetails['firstName']; ?>" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="middleName" class="form-label">Middle Name</label>
                                <input type="text" class="form-control" name="lesseeMiddleName" id="middleName"
                                    value="<?php echo $tenantDetails['middleName']; ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="lastName" class="form-label">Last Name*</label>
                                <input type="text" class="form-control" name="lesseeLastName" id="lastName"
                                    value="<?php echo $tenantDetails['lastName']; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="lesseeDOB"
                                        value="<?php echo $tenantDetails['dateOfBirth']; ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="gender" class="form-label">Gender*</label>
                                    <select class="form-select" name="lesseeGender" required>
                                        <option value="">Select gender</option>
                                        <option value="Male" <?php if ($tenantDetails['gender'] == 'Male')
                                            echo 'selected'; ?>>Male</option>
                                        <option value="Female" <?php if ($tenantDetails['gender'] == 'Female')
                                            echo 'selected'; ?>>Female</option>
                                        <option value="Prefer not to say" <?php if ($tenantDetails['gender'] == 'Prefer not to say')
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="lesseePhone"
                                        value="<?php echo $tenantDetails['phone']; ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label">Email*</label>
                                    <input type="email" class="form-control" name="lesseeEmail"
                                        value="<?php echo $tenantDetails['email']; ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row bg-secondary-subtle rounded pt-3 pb-4 mt-5">
                <div class="col">
                    ...
                    <div id="occupants">
                        ...
                        <div class="occupant mb-3">
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="firstName" class="form-label">First Name*</label>
                                    <input type="text" class="form-control" name="occFirstName[]"
                                        value="<?php echo $tenantDetails['firstName']; ?>" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="middleName" class="form-label">Middle Name</label>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="lastName" class="form-label">Last Name*</label>
                                    <input type="text" class="form-control" name="occLastName[]"
                                        value="<?php echo $tenantDetails['lastName']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        <label for="dateOfBirth" class="form-label">Date of Birth*</label>
                                        <input type="date" class="form-control" name="occDOB[]"
                                            value="<?php echo $tenantDetails['dateOfBirth']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="gender" class="form-label">Gender*</label>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        <label for="phone" class="form-label">Phone*</label>
                                        <input type="text" class="form-control" name="occPhone[]"
                                            value="<?php echo $tenantDetails['phone']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Email*</label>
                    ...
                    <button type="button" class="btn btn-success" id="addOccupant">Add Occupant</button>
                </div>
            </div>
    ...
    <div class="container mt-5">
        ...
        <div class="row bg-secondary-subtle py-4 rounded" id="printableDiv">
            <div class="col">
                <div>
                    ...
                    <p class="lh-base">This Lease Agreement (hereinafter referred to as the
                        <strong>"Agreement"</strong>) made this <u id="currentDate"> <?php echo date('F d, Y'); ?></u> ,
                        by and between <u id="tenantName">___</u> (hereinafter referred to as the
                        <strong>"Tenant"</strong>), and <u>Lance Geo Majorenos Cerenio</u> (hereinafter referred to as
                        the <strong>"Landlord"</strong>)(collectively referred to as the <strong>"Parties"</strong>).
                    </p>

                    <h5 class="fw-bold">II. PREMISES, USE AND OCCUPANCY</h5>
                    <P class="lh-base">The Premises that are to be rented are located at (address)
                        <u><?php echo $apartment['apartmentAddress']; ?>.</u></P>
                    <p class="lh-base">The Premises to be used only for residential purposes and may be occupied only by
                        the registered occupants.</p>
                    <p class="lh-base">NOW, THEREFORE, FOR AND IN CONSIDERATION of the mutual promises and agreements
                    ...
                    <p class="lh-base">The Tenant shall be allowed to occupy the Premises starting on <u
                            id="effectiveDate">___</u>(the <strong>"Effective Date"</strong>), and end on <u
                            id="leaseTerm">___</u>(<strong>"End Date"</strong>)(collectively referred to as the
                        <strong>"Lease Term"</strong>).</p>
                    <p class="lh-base">The Tenant shall vacate the Premises at the end of the Lease Term if the Parties
                        do not agree on a new Lease Agreement or an extension of this Agreement.</p>

                    <h5 class="fw-bold">IV. PAYMENT TERMS</h5>
                    <P class="lh-base">The monthly rent to be paid by the Tenant to the Landlord is
                        <u>₱<?php echo $apartment['rentPerMonth']; ?>/month</u>. It is to be paid by the Tenant before
                        the first day of every month, such that the first rent payment is due on <u><span
                                id="firstRentPaymentDueDate">___</span></u>.</P>
                    <!-- <p class="lh-base">The method of payment preferred by both parties is/are <u id="preferredPayment">Cash/Gcash/Bank</u>.</p> -->
                    <p class="lh-base">In the event of late payments made by the Tenant, the Landlord is entitled to
                        impose a <u>₱<span id="lateFee">___</span>(10% of monthly rent)</u> fine as <strong>late
                            fee</strong> for each day of delay within the <u>three (3) day grace period.</u></p>
                    <p class="lh-base">Prior to taking occupancy of the Premises, the Tenant will pay the Landlord an
                        amount of <u>₱<?php echo $apartment['rentPerMonth']; ?></u> as a <strong>security
                            deposit</strong> to cover the cost of any damages suffered by the Premises and cleaning.
                        Such security deposit will be returned to the Tenant upon the end of this Agreement, provided
                        the Premises are left in the same condition as prior to the occupancy.</p>
                </div>
            </div>
            <div class="row mt-4">
        ...
        <button type="button" class="btn btn-primary mt-5 mb-5" data-bs-toggle="modal"
