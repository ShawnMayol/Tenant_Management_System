        ...
        <div class="container">
            <div class="row">
                <div class="col-auto ps-2 pe-3">
                    <a href="?page=manager.payments" class="icon-wrapper" style="text-decoration: none;">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-12 mt-3">
                            <div class="position-relative">
                                ...
                                <p class="text-center mt-3"><a href="?page=manager.viewUser&tenant_id=<?php echo $tenant_id; ?>" class="text-decoration-none">Show Occupants</a></p>
                            </div>
                        </div>
