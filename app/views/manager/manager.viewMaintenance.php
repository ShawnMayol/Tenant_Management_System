        ...
        <div class="container">
            <div class="row">
                <div class="col-auto ps-2 pe-3">
                    <a href="?page=manager.maintenance" class="icon-wrapper" style="text-decoration: none;">
            ...
            <div class="col-lg-6">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        <tbody>
                            <tr class="clickable-row" data-href="?page=manager.viewApartment&apartment=<?php echo htmlspecialchars($request['apartmentNumber']); ?>">
