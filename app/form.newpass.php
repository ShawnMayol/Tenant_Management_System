<!-- New Password Form -->
<?php ?>
<form action="changePassword.php" method="POST" class="text-center" id="newPasswordForm">
    <br><br><br>
    ...
    <div class="d-flex justify-content-start my-3">
        <a href="?login[page]=form.login" class="text-decoration-none go-back-link">Go back to login</a>
    </div>
