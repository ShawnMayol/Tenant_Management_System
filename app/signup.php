...
<head>
    ...
    <link rel="icon" href="assets/src/img/web-icon.png">
...
<div class="container">
  ...
  <div class="form-signup">
    ...
    <form action="signup_handler.php" method="POST">
      <img class="mb-2" src="assets/src/img/web-icon.png" alt="" width="40" height="35">
      ...
      <p id="passwordWarning" class="warning">Passwords do not match!</p>

      <div class="d-flex justify-content-start my-3">
        <a href="login.php" class="text-decoration-none">Already have an account?</a>
      </div>

      <button class="btn btn-primary w-100 py-2" id="signup-btn" type="submit" disabled>Sign up</button>
      <p class="mt-3 text-body-secondary">&copy; C-Apartments 2024</p>
    </form>
  </div>
</div>
<script src="assets/dist/js/bootstrap.bundle.min.js"></script>
<script src="assets/src/js/signup.js"></script>
</body>
</html>